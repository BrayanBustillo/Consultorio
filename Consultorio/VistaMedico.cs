...
{
    public partial class VistaMedico : Form
    {
        private NMedico nVariable;
        public VistaMedico()
        {
            InitializeComponent();
            nVariable = new NMedico();
        }
        ...
        {
            var grupo = nVariable.obtener().Select(c => new { c.MedicoId, c.Nombres, c.Apellidos, c.FechaIngreso, c.Estado });
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (Agregar)
            {
                nVariable.Agregar(new Datos.BaseDatos.Modelos.Medico()
                {
            ...
            {
                nVariable.Editar(new Datos.BaseDatos.Modelos.Medico()
                {
                    MedicoId = int.Parse(id),
                    Nombres = Nombres,
                    Apellidos = Apellidos,
        ...
        private void DGVDatos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtID.Text = DGVDatos.CurrentRow.Cells["MedicoId"].Value.ToString();
